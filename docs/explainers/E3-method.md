...
ledger** (`docs/ERRATA.md`), which currently holds **27** entries. <!-- claim:E3-14 --> Two are
...
records a self-caught protocol breach that **had consequences**: a confirmation-class
computation run outside the pre-registration protocol, with a tolerance fit after seeing its
residuals. It mattered — the peek appeared to show the trough *in agreement*, a reading the
later clean confirmation **overturned** (the trough is in fact a persistent deviation). The
breach did not merely risk a wrong conclusion; it produced one, which only the proper protocol
caught. <!-- claim:E3-16 -->
