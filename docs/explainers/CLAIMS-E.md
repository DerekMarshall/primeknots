...
| E1-36 | The height-ordered EC density is a separate conjecture; its tail is where our results flag a deviation | SS25 Conjecture 1; docs/preregistered/PR-1.md postscript |
...
| E3-2 | `a_p` two ways (fast table charsum vs frozen referee) agree on a certified sample spanning the range | test `twin_ap_fast_vs_charsum_m4` (verify/m4) |
